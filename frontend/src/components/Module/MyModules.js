        ...
        <div >
            <main id="main" data-aos="fade-in">
                <div class="breadcrumbs">
                    <div class="container">
                        <h2  style={{ color: "black" }}>My Modules</h2>
                    </div>
                </div>
                                                        ...
                                                        <div class="d-flex flex-column flex-lg-row">
                                                            ...
                                                            <div class="row flex-fill">
                                                                <div class="col-sm-5">
                                                                    ...
                                                                    &nbsp;  &nbsp;  &nbsp;<span style={{ color: "black"}}>Last edit : </span><span style={{ color: "rgb(5, 68, 104)" }}>{date_update.substring(0, 10)}</span>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-3 text-lg-end">
                                                                    ...
                                                                    <a onClick={() => {
                                                                        setUpdate(!update)
                                                                        setid(_id)
                                                                    }} style={{ border: 0, background: "transparent", color: "#5FCF80" }} class="table-link">
                                                                        <span class="fa-stack">
                                                                    ...
                                                                    <a onClick={() => OnDelete(_id)} style={{ border: 0, background: "transparent", color: "red" }} class="table-link">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-square fa-stack-2x"></i>
