...
const Evaluations = (props) => {
  ...
  if(connectedUser.type!=="admin"){
    idModule=props.location.state.idmodule;
  }
  ...
  evresults == true ? (<EvResults evaluations={evaluations} evresults={setEvResults}/>):
   ( 
      <>
        ...
        <a onClick={() => { history.goBack()  }}><i style={{ color: "rgb(5, 68, 104)" }} class="fas fa-arrow-circle-left fa-2x  "></i></a>
        ...
        {evaluations  && owner!=null &&
          ...
          <div class="row">
            <div class="table-responsive">
              <table class="table table_evaluation user-list"  >
                <tbody>
                  {
