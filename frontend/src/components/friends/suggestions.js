                    ...
                    {Suggestions &&
                        Suggestions.map((suggestion, index) => (
                            <div class="col-md-6" suggestion={suggestion}
                                ...
                                <div class="card cardSuggestions" id="mydiv"  >
                                    <div class="card-body cardSuggestions-body p-t-10">
                                        <div class="media-main">
                                            <a class="pull-left" >
                                                {suggestion.image.startsWith("https") &&

                                                    <img src={suggestion.image} class="profile-photo-lg"
                                                        referrerpolicy="no-referrer"></img>
                                                }
                                                {!suggestion.image.startsWith("https") && <img class="profile-photo-lg" src={require('../../assets/uploads/user/' + suggestion.image)} alt=""
                                                />
                                                }
                                            </a>
                                            ...
                                            <div class="info" style={{ height: "130px" }}>
                                               <a  style={{color:"black"}}href={`/check/${suggestion._id}`}> <h4 class="text-capitalize">{suggestion.name} {suggestion.lastName}</h4></a>
